...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between bg-white dark:bg-black px-4 py-3 dark:px-4 dark:py-3'>
      {/* search-bar */}
      ...
      <div className='flex items-center'>
        <button 
          ...
          className={isDarkMode ? 'rounded p-2 dark:hover:bg-gray-700' : 'hover:bg-gray-100'}>
            {isDarkMode ? (
        ...
        >
          <Settings className='h-6 cursor-pointer dark:text-white' />
        </Link>
