    ...
    return(
        ...
        >
            <div className='mb-3 flex w-full'>
                ...
                />
                <div className='flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secodary'>
...
const Task = ({ task }: TaskProps) => {
    ...
    return(
        <div
            ...
            className={`mb-4 rounded-md bg-white shadow dark:bg-dark-secodary ${
                    ...
                    <div className='flex -space-x-[6px] overflow-hidden'>
                        {task.assignee && (
                            <Image 
                                ...
                                width={30}
                                height={30}
                                className='h-8 w-8 rounded-full border-2 border-white object-cover dark:border-dark-secodary'
                            />
                        )}
                        {task.author && (
                            <Image 
