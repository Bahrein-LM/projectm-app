...
const HomePage = () => {
  ...
  if(tasksError || !tasks || !projects) return console.error(tasksError)
  ...
  return (
    <div className='container h-full w-[100%] bg-gray-100 bg-transparent p-8'>
      <Header name='Project Management Dasboard' />
      <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
        <div className='rounded-lg bg-white p-4 shadow dark:bg-dark-secodary'>
        ...
        <div className='rounded-lg bg-white p-4 shadow dark:bg-dark-secodary md:col-span-2'>
          <h3 className='mb-4 text-lg font-semibold dark:text-white'>
            Your Tasks
          </h3>
